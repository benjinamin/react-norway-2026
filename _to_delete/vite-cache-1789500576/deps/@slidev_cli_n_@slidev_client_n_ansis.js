...
//#endregion
//#region node_modules/.pnpm/ansis@4.4.0/node_modules/ansis/index.mjs
var import_ansis = /* @__PURE__ */ __toESM((/* @__PURE__ */ __commonJSMin(((exports, module) => {
	...
	var d = new function t(s = globalThis) {
		let d = "number" == typeof s ? s : ((r) => {
			...
			try {
				i = ((r, t, n) => (e = t.TERM, "dumb" === e ? 0 : {
					"24bit": 3,
					truecolor: 3,
					ansi256: 2,
					ansi: 1
				}[t.COLORTERM] || (t.CI ? /,GITHUB/.test(n) ? 3 : 1 : r.stdout?.isTTY || t.PM2_HOME || /edge/.test(t.NEXT_RUNTIME) ? "win32" === r.platform ? 3 : /-256/.test(e) ? 2 : 1 : 0)))(t, o, "," + l(o).join(","));
			} catch (e) {
				o = {};
			}
